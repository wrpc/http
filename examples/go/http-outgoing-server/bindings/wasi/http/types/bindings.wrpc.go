...
import (
	...
	wasi__io__error "wrpc.io/http/examples/go/http-outgoing-server/bindings/wasi/io/error"
	wasi__io__poll "wrpc.io/http/examples/go/http-outgoing-server/bindings/wasi/io/poll"
	wasi__io__streams "wrpc.io/http/examples/go/http-outgoing-server/bindings/wasi/io/streams"
)
