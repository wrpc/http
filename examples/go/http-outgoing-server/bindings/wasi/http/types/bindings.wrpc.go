...
import (
	...
	errors "errors"
	fmt "fmt"
	wasi__clocks__monotonic_clock "github.com/wrpc/http/examples/go/http-outgoing-server/bindings/wasi/clocks/monotonic_clock"
	wasi__io__error "github.com/wrpc/http/examples/go/http-outgoing-server/bindings/wasi/io/error"
	wasi__io__poll "github.com/wrpc/http/examples/go/http-outgoing-server/bindings/wasi/io/poll"
	wasi__io__streams "github.com/wrpc/http/examples/go/http-outgoing-server/bindings/wasi/io/streams"
