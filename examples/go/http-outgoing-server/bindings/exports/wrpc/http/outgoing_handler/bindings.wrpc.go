...
import (
	...
	wasi__http__types "github.com/wrpc/http/examples/go/http-outgoing-server/bindings/wasi/http/types"
	wrpc__http__types "github.com/wrpc/http/examples/go/http-outgoing-server/bindings/wrpc/http/types"
