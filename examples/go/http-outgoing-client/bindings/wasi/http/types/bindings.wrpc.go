...
import (
	...
	utf8 "unicode/utf8"
	wrpc "wrpc.io/go"
	wasi__clocks__monotonic_clock "wrpc.io/http/examples/go/http-outgoing-client/bindings/wasi/clocks/monotonic_clock"
	wasi__io__error "wrpc.io/http/examples/go/http-outgoing-client/bindings/wasi/io/error"
	wasi__io__poll "wrpc.io/http/examples/go/http-outgoing-client/bindings/wasi/io/poll"
	wasi__io__streams "wrpc.io/http/examples/go/http-outgoing-client/bindings/wasi/io/streams"
)
