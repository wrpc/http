...
<li>interface <a href="#wrpc_http_types_0_1_0"><code>wrpc:http/types@0.1.0</code></a></li>
<li>interface <a href="#wrpc_http_outgoing_handler_0_1_0"><code>wrpc:http/outgoing-handler@0.1.0</code></a></li>
<li>interface <a href="#wasi_clocks_wall_clock_0_2_0"><code>wasi:clocks/wall-clock@0.2.0</code></a></li>
</ul>
</li>
<li>Exports:
<ul>
<li>interface <a href="#wrpc_http_incoming_handler_0_1_0"><code>wrpc:http/incoming-handler@0.1.0</code></a></li>
</ul>
</li>
</ul>
...
<p>The user may provide an <a href="#error"><code>error</code></a> to <a href="#response"><code>response</code></a> to allow the
...
<li><a name="static_response_outparam_set.response"></a><a href="#response"><code>response</code></a>: result&lt;own&lt;<a href="#outgoing_response"><a href="#outgoing_response"><code>outgoing-response</code></a></a>&gt;, <a href="#error_code"><a href="#error_code"><code>error-code</code></a></a>&gt;</li>
</ul>
...
<h2><a name="wrpc_http_types_0_1_0"></a>Import interface wrpc:http/types@0.1.0</h2>
<hr />
<h3>Types</h3>
<h4><a name="wasi_error_code"></a><code>type wasi-error-code</code></h4>
<p><a href="#error_code"><a href="#error_code"><code>error-code</code></a></a></p>
<p>
#### <a name="wasi_method"></a>`type wasi-method`
[`method`](#method)
<p>
#### <a name="wasi_request_options"></a>`type wasi-request-options`
[`request-options`](#request_options)
<p>
#### <a name="wasi_scheme"></a>`type wasi-scheme`
[`scheme`](#scheme)
<p>
...
[`wasi-error-code`](#wasi_error_code)
<p>
#### <a name="method"></a>`type method`
[`wasi-method`](#wasi_method)
<p>
#### <a name="scheme"></a>`type scheme`
[`wasi-scheme`](#wasi_scheme)
<p>
#### <a name="fields"></a>`type fields`
[`fields`](#fields)
<p>
#### <a name="request_options"></a>`record request-options`
<h5>Record Fields</h5>
<ul>
<li><a name="request_options.connect_timeout"></a><code>connect-timeout</code>: option&lt;<a href="#duration"><a href="#duration"><code>duration</code></a></a>&gt;</li>
<li><a name="request_options.first_byte_timeout"></a><code>first-byte-timeout</code>: option&lt;<a href="#duration"><a href="#duration"><code>duration</code></a></a>&gt;</li>
<li><a name="request_options.between_bytes_timeout"></a><code>between-bytes-timeout</code>: option&lt;<a href="#duration"><a href="#duration"><code>duration</code></a></a>&gt;</li>
</ul>
<h4><a name="request"></a><code>record request</code></h4>
<h5>Record Fields</h5>
<ul>
<li><a name="request.body"></a><code>body</code>: stream&lt;<code>u8</code>&gt;</li>
<li><a name="request.trailers"></a><a href="#trailers"><code>trailers</code></a>: future&lt;option&lt;<a href="#fields"><a href="#fields"><code>fields</code></a></a>&gt;&gt;</li>
<li><a name="request.method"></a><a href="#method"><code>method</code></a>: <a href="#method"><a href="#method"><code>method</code></a></a></li>
<li><a name="request.path_with_query"></a><code>path-with-query</code>: option&lt;<code>string</code>&gt;</li>
<li><a name="request.scheme"></a><a href="#scheme"><code>scheme</code></a>: option&lt;<a href="#scheme"><a href="#scheme"><code>scheme</code></a></a>&gt;</li>
<li><a name="request.authority"></a><code>authority</code>: option&lt;<code>string</code>&gt;</li>
<li><a name="request.headers"></a><a href="#headers"><code>headers</code></a>: <a href="#fields"><a href="#fields"><code>fields</code></a></a></li>
</ul>
<h4><a name="response"></a><code>record response</code></h4>
<h5>Record Fields</h5>
<ul>
<li><a name="response.body"></a><code>body</code>: stream&lt;<code>u8</code>&gt;</li>
<li><a name="response.trailers"></a><a href="#trailers"><code>trailers</code></a>: future&lt;option&lt;<a href="#fields"><a href="#fields"><code>fields</code></a></a>&gt;&gt;</li>
<li><a name="response.status"></a><code>status</code>: <code>u16</code></li>
<li><a name="response.headers"></a><a href="#headers"><code>headers</code></a>: <a href="#fields"><a href="#fields"><code>fields</code></a></a></li>
</ul>
<h2><a name="wrpc_http_outgoing_handler_0_1_0"></a>Import interface wrpc:http/outgoing-handler@0.1.0</h2>
<hr />
<h3>Types</h3>
<h4><a name="request"></a><code>type request</code></h4>
<p><a href="#request"><a href="#request"><code>request</code></a></a></p>
<p>
#### <a name="response"></a>`type response`
[`response`](#response)
<p>
#### <a name="error_code"></a>`type error-code`
...
<h5>Params</h5>
<ul>
<li><a name="handle.request"></a><a href="#request"><code>request</code></a>: <a href="#request"><a href="#request"><code>request</code></a></a></li>
<li><a name="handle.options"></a><code>options</code>: option&lt;<a href="#request_options"><a href="#request_options"><code>request-options</code></a></a>&gt;</li>
</ul>
<h5>Return values</h5>
<ul>
<li><a name="handle.0"></a> result&lt;<a href="#response"><a href="#response"><code>response</code></a></a>, <a href="#error_code"><a href="#error_code"><code>error-code</code></a></a>&gt;</li>
</ul>
...
<h2><a name="wrpc_http_incoming_handler_0_1_0"></a>Export interface wrpc:http/incoming-handler@0.1.0</h2>
<hr />
<h3>Types</h3>
<h4><a name="request"></a><code>type request</code></h4>
<p><a href="#request"><a href="#request"><code>request</code></a></a></p>
